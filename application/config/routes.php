...
$route['add_payslip/(:num)/(:num)']= 'payroll/add_payslip/$1/$2';
$route['payroll_period']		   = 'payroll/payroll_period';
$route['payroll_view/(:num)']	   = 'payroll/payroll_view/$1';
$route['insert_payslip']		   = 'payroll/insert_payslip';
$route['view_payslip']			   = 'payroll/view_payslip';
$route['my_payslip/(:num)']		   = 'payroll/my_payslip/$1';